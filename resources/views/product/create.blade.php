        ...
        <div class="d-flex justify-content-between gap-2 p-5 w-100 container mx-auto">
            <div class="d-flex flex-column gap-5 w-50">
                <div class="column-1 w-100 d-flex justify-content-between">
                    ...
                    <input type="text" name="destination" class="form-control w-75" placeholder="Travel destination">
                </div>

                <div class="column-1 w-100 d-flex justify-content-between">
                    <p class="w-25 fs-6 fw-bold">Title</p>
                    <input required type="text" name="product_title" class="form-control w-75" placeholder="Enter product title">
                </div>
                {{-- category --}}
                @if($categories)
                    <div class="column-1 w-100 d-flex justify-content-between">
                        <p class="w-25 fs-6 fw-bold">Category</p>
                        <select name="category_id" class="form-select w-75" id="">
                ...
                @if( $suppliers )
                    <div class="column-1 w-100 d-flex justify-content-between">
                        ...
                        <select name="supplier_id" class="form-select w-75" id="">
                ...
                <div class="column-2 w-100 w-100 d-flex justify-content-between">
                    ...
                    <textarea name="description" id="" cols="30" rows="6" class="form-control w-75"></textarea>
                </div>
                {{-- highlight ends --}}
                ...
                <div class="column-2 w-100 w-100 d-flex justify-content-between">
                    ...
                    <div class="w-75 d-flex flex-column gap-4">
                        <div class="d-flex align-items-center gap-3">
                            <input name="adults" type="number" class="form-control" placeholder="Adults">
                            <p>age</p>
                            <input name="adult_age" type="number" class="form-control" placeholder="0">
                            <p>price</p>
                            <input name="adult_amount" type="number" id="adult_price" class="form-control" placeholder="$">
                        </div>

                        <div class="d-flex align-items-center gap-3">
                            <input name="boys" type="number" class="form-control" placeholder="Boys">
                            <p>age</p>
                            <input name="boy_age" type="number" class="form-control" placeholder="0">
                            <p>price</p>
                            <input name="boy_amount" type="number" id="boy_price" class="form-control" placeholder="$">
                        </div>

                        <div class="d-flex align-items-center gap-3">
                            <input name="infants" type="number" class="form-control" placeholder="Infants">
                            <p>age</p>
                            <input name="infant_age" type="number" class="form-control" placeholder="0">
                            <p>price</p>
                            <input name="infant_amount" type="number" id="infant_price" class="form-control" placeholder="$">
                        </div>
                    </div>
                </div>
                {{-- prices end --}}
                <div class="column-1 w-100 d-flex justify-content-between">
                    ...
                    <input type="text" id="total_price" name="total_price" class="form-control w-75" placeholder="Enter product price">
                </div>
                ...
                <div class="column-2 w-100 w-100 d-flex justify-content-between">
                    ...
                    <div class="w-75 d-flex flex-column gap-4">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="number" class="form-control" placeholder="Boys">
                            <p>Discount</p>
                            <input type="number" class="form-control" placeholder="0">
                            <p>From</p>
                            <input type="date" class="form-control">
                ...
                <div class="column-2 w-100 d-flex justify-content-between">
                    ...
                    <textarea name="description" id="" cols="10" rows="6" class="form-control w-75"></textarea>
                ...
                <div class="column-1 w-100 d-flex justify-content-between">
                    ...
                    <input type="text" name="meeting_point" class="form-control w-75" placeholder="Travel destination">
                </div>


                <div class="column-1 w-100 d-flex justify-content-between">
                    <p class="w-25 fs-6 fw-bold">Destination Address</p>
                    <input type="text" name="destination_address" class="form-control w-75" placeholder="Travel destination">
                </div>
                <div class="column-1 w-100 d-flex justify-content-between">
                    <p class="w-25 fw-bold">Address</p>
                    <input type="address" id="address" class="mx-3 w-50 form-control" name="address" placeholder="Enter address...">
            ...
            <div class="d-flex flex-column w-50 gap-5">
                <div class="column-1 w-100 d-flex justify-content-between">
                    ...
                    <input type="text" name="cancellation" class="form-control w-75" placeholder="Up two days before">
                </div>

                <div class="column-1 w-100 d-flex justify-content-between">
                    <p class="w-25 fs-6 fw-bold">Duration of service</p>
                    <input type="text" name="duration_of_service" class="form-control w-75" placeholder="Enter the duration of service in days">
                </div>
                ...
                <div class="column-2 w-100 w-100 d-flex justify-content-start">
                    ...
                    <input type="checkbox" value="1" name="immediate_reconfirmation" class="form-check-input">
                </div>
